...
CREATE TABLE `fornecedor` (
  ...
  KEY `codcidade_idx` (`codcidade`),
  CONSTRAINT `codcidade` FOREIGN KEY (`codcidade`) REFERENCES `cidade` (`codcidade`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `produto` (
  ...
  `controlado` tinyint DEFAULT NULL,
  `qtdem` int DEFAULT NULL,
  PRIMARY KEY (`codproduto`),
  KEY `codcategoria_idx` (`codfornecedor`),
  CONSTRAINT `codcategoria` FOREIGN KEY (`codfornecedor`) REFERENCES `categoria` (`codcategoria`),
...
-- Dump completed on 2025-09-28 11:08:28
